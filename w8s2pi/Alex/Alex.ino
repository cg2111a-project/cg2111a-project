...
#define ALEX_LENGTH 23
#define Alex_BREADTH 16
#define ALEX_DIGONAL 28
#define ALEX_CIRC 88
...
void bareWrite(int port, int val) {
    if (port == LR) {
        OCR1A = val;
    } else if (port == LF) {
        OCR1B = val;
